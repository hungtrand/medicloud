...
},{"../Shared/authorization.interceptor":1,"./calendar/calendar.module":4,"./error/error.directive":8,"./patient/patient.module":22,"./patients/patients.module":25}],3:[function(require,module,exports){
  ...
  return {
    link: function($scope, elem, attr) {
      ...
      $("[data-date]").click(function() {
        console.log('modalControlShow is ' + $scope.modalControl.show);
...
},{"../../Shared/authorization.interceptor":1,"./formAddPatient/formAddPatient.directive":24,"./patientsList/patientsList.controller":26,"./patientsList/patientsList.service":27}],26:[function(require,module,exports){
